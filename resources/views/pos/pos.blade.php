		...
		<div class="grid-container">
			<div class="card shadow-sm">
				<div class="customer">
					...
					<button class="btn btn-primary waves-effect waves-light" style="margin:4px" data-toggle="modal"
						data-target="#con-close-modal">Add Customer</button>
				</div>
				...
				<div class="form-group">
					...
					<form action="{{ URL::to('/create-invoice') }}" method="get">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<button type="submit" class="btn btn-success w-md waves-effect waves-light">Check
									invoice</button>
							</div>
						</div>
					</form>
								...
								<table class="table">
									...
									<thead>
										<tr class="bg-purple" style="width: 100%;">
											<th class="text-white d-flex text-center" scope="col" style="width: 25%;">
												Name</th>
											<th class="text-white d-flex text-center" scope="col" style="width: 25%;">
												Single Prize</th>
											<th class="text-white d-flex text-center" scope="col" style="width: 25%;">
			...
			<div class="card shadow-sm">
				<div class="card-title " style="display: flex;justify-content: space-between;align-items: center; ">
					...
					<a href="{{URL::to('update-product-qty-view')}}" class="btn btn-primary waves-effect waves-light float-right"
						style="margin:4px">Update Product
						Qty</a>
				</div>
				<div class="card-body">
